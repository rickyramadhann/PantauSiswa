 ...
 */
var Lihatnilaik = (function () {
    function Lihatnilaik(navCtrl, navParams) {
    ...
    Lihatnilaik.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Lihatnilaik');
    };
    return Lihatnilaik;
}());
Lihatnilaik = __decorate([
    IonicPage(),
    Component({
...
export { Lihatnilaik };
//# sourceMappingURL=lihatnilaik.js.map